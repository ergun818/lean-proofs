...
omit [Fintype V] in
theorem covered_color_count [Finite V] (H : SetHypergraph V) (c : H.EdgeColoring C) (v : V) :
...
omit [Fintype V] in
theorem all_color_absences [Finite V] (H : SetHypergraph V) (c : H.EdgeColoring C) (v : V) :
...
theorem special_palette_incident_lower [Finite C] [Finite V] (H : SetHypergraph V) (c :
  H.EdgeColoring C)
...
omit [Fintype V] in
theorem active_absences_le_all [Finite V] (H : SetHypergraph V) (c : H.EdgeColoring C)
...
omit [Fintype V] in
theorem active_requests_le_of_incident_lower [Finite V] (H : SetHypergraph V)
...
omit [Fintype V] in
theorem graph_degree_le_colored_incidence_add_residual [Finite V] (H J : SetHypergraph V)
