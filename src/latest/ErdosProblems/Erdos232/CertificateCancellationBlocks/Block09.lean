...
theorem congruenceBlock09_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt09 s.val : ℝ)) = (((((((weightedMaskMass a 41216
        (43490003) + (-weightedMaskMass a 5242888 (43490003) + weightedMaskMass a 41218
        (-21815204))) + (-weightedMaskMass a 589956 (-21815204) + (weightedMaskMass a 41220
        (-20029353) + -weightedMaskMass a 1311240 (-20029353)))) + ((weightedMaskMass a 41220
        (42745045) + (-weightedMaskMass a 1572996 (42745045) + weightedMaskMass a 41224 (6831432)))
        + (-weightedMaskMass a 245760 (6831432) + (weightedMaskMass a 41232 (32068850) +
        -weightedMaskMass a 233472 (32068850))))) + (((weightedMaskMass a 41240 (6143927) +
        (-weightedMaskMass a 249856 (6143927) + weightedMaskMass a 49160 (-138175998))) +
        (-weightedMaskMass a 147520 (-138175998) + (weightedMaskMass a 49160 (51321554) +
        -weightedMaskMass a 540736 (51321554)))) + ((weightedMaskMass a 49161 (-56841406) +
        (-weightedMaskMass a 540737 (-56841406) + weightedMaskMass a 49161 (191617380))) +
        ((-weightedMaskMass a 2244672 (191617380) + weightedMaskMass a 49170 (129733778)) +
        (-weightedMaskMass a 196642 (129733778) + weightedMaskMass a 49170 (-61971372)))))) +
        ((((-weightedMaskMass a 540708 (-61971372) + (weightedMaskMass a 49170 (89231465) +
        -weightedMaskMass a 1057288 (89231465))) + (weightedMaskMass a 49170 (-115632363) +
        (-weightedMaskMass a 1083648 (-115632363) + weightedMaskMass a 49172 (165621861)))) +
        ((-weightedMaskMass a 132162 (165621861) + (weightedMaskMass a 49172 (153772508) +
        -weightedMaskMass a 196674 (153772508))) + (weightedMaskMass a 49172 (31606482) +
        (-weightedMaskMass a 540692 (31606482) + weightedMaskMass a 49172 (301090))))) +
        (((-weightedMaskMass a 1048852 (301090) + (weightedMaskMass a 49172 (-211684744) +
        -weightedMaskMass a 1097984 (-211684744))) + (weightedMaskMass a 49176 (13124661) +
        (-weightedMaskMass a 151616 (13124661) + weightedMaskMass a 49176 (-25100790)))) +
        ((-weightedMaskMass a 540740 (-25100790) + (weightedMaskMass a 49217 (89681071) +
        -weightedMaskMass a 90120 (89681071))) + ((weightedMaskMass a 49217 (-147887233) +
        -weightedMaskMass a 540681 (-147887233)) + (weightedMaskMass a 49218 (-57773739) +
        -weightedMaskMass a 540712 (-57773739))))))) + (((((weightedMaskMass a 49218 (68186714) +
        (-weightedMaskMass a 1073160 (68186714) + weightedMaskMass a 49220 (-11210596))) +
        (-weightedMaskMass a 540696 (-11210596) + (weightedMaskMass a 49280 (145733400) +
        -weightedMaskMass a 131264 (145733400)))) + ((weightedMaskMass a 49280 (121085192) +
        (-weightedMaskMass a 131648 (121085192) + weightedMaskMass a 49280 (-173525917))) +
        (-weightedMaskMass a 557064 (-173525917) + (weightedMaskMass a 49280 (-260797329) +
        -weightedMaskMass a 557120 (-260797329))))) + (((weightedMaskMass a 49280 (64617846) +
        (-weightedMaskMass a 1048864 (64617846) + weightedMaskMass a 49280 (122556))) +
        (-weightedMaskMass a 3145760 (122556) + (weightedMaskMass a 49281 (7309327) +
        -weightedMaskMass a 561216 (7309327)))) + ((weightedMaskMass a 49281 (1535128) +
        (-weightedMaskMass a 1049376 (1535128) + weightedMaskMass a 49281 (142563377))) +
        ((-weightedMaskMass a 2228800 (142563377) + weightedMaskMass a 49281 (-42803868)) +
        (-weightedMaskMass a 3145764 (-42803868) + weightedMaskMass a 49282 (-85043974)))))) +
        ((((-weightedMaskMass a 622600 (-85043974) + (weightedMaskMass a 49282 (17035733) +
        -weightedMaskMass a 1050912 (17035733))) + (weightedMaskMass a 49282 (71968194) +
        (-weightedMaskMass a 2654272 (71968194) + weightedMaskMass a 49282 (69380264)))) +
        ((-weightedMaskMass a 3145762 (69380264) + (weightedMaskMass a 49284 (-158648533) +
        -weightedMaskMass a 1065248 (-158648533))) + (weightedMaskMass a 49284 (298608833) +
        (-weightedMaskMass a 1605640 (298608833) + weightedMaskMass a 49284 (-13749006))))) +
        (((-weightedMaskMass a 3145768 (-13749006) + (weightedMaskMass a 49410 (-38261414) +
        -weightedMaskMass a 69666 (-38261414))) + (weightedMaskMass a 49410 (15364964) +
        (-weightedMaskMass a 622596 (15364964) + weightedMaskMass a 49410 (-17445260)))) +
        ((-weightedMaskMass a 1050896 (-17445260) + (weightedMaskMass a 49410 (89291887) +
        -weightedMaskMass a 2654224 (89291887))) + ((weightedMaskMass a 49412 (31944426) +
        -weightedMaskMass a 69698 (31944426)) + (weightedMaskMass a 49412 (-180008498) +
        -weightedMaskMass a 1065232 (-180008498)))))))) + ((((((weightedMaskMass a 49412 (122027273)
        + (-weightedMaskMass a 1081364 (122027273) + weightedMaskMass a 49412 (241267518))) +
        (-weightedMaskMass a 1605636 (241267518) + (weightedMaskMass a 49412 (-75870569) +
        -weightedMaskMass a 2359816 (-75870569)))) + ((weightedMaskMass a 49416 (173083537) +
        (-weightedMaskMass a 213056 (173083537) + weightedMaskMass a 49426 (-73992102))) +
        (-weightedMaskMass a 200738 (-73992102) + (weightedMaskMass a 49426 (9891076) +
        -weightedMaskMass a 1083664 (9891076))))) + (((weightedMaskMass a 49428 (-76773069) +
        (-weightedMaskMass a 200770 (-76773069) + weightedMaskMass a 49428 (-138407282))) +
        (-weightedMaskMass a 1081620 (-138407282) + (weightedMaskMass a 49428 (195482606) +
        -weightedMaskMass a 1098000 (195482606)))) + ((weightedMaskMass a 49432 (-45270136) +
        (-weightedMaskMass a 217152 (-45270136) + weightedMaskMass a 53249 (-44764357))) +
        ((-weightedMaskMass a 73746 (-44764357) + weightedMaskMass a 53249 (-5576339)) +
        (-weightedMaskMass a 73748 (-5576339) + weightedMaskMass a 53249 (73573783)))))) +
        ((((-weightedMaskMass a 73752 (73573783) + (weightedMaskMass a 53249 (-86175756) +
        -weightedMaskMass a 4724736 (-86175756))) + (weightedMaskMass a 268289 (-1316681) +
        (-weightedMaskMass a 530433 (-1316681) + weightedMaskMass a 268289 (-51947844)))) +
        ((-weightedMaskMass a 2361348 (-51947844) + (weightedMaskMass a 268289 (23395306) +
        -weightedMaskMass a 2490372 (23395306))) + (weightedMaskMass a 53250 (-96931111) +
        (-weightedMaskMass a 73762 (-96931111) + weightedMaskMass a 53250 (39506580))))) +
        (((-weightedMaskMass a 1056792 (39506580) + (weightedMaskMass a 53250 (54665419) +
        -weightedMaskMass a 1574913 (54665419))) + (weightedMaskMass a 53252 (-56952225) +
        (-weightedMaskMass a 73794 (-56952225) + weightedMaskMass a 53313 (-25897446)))) +
        ((-weightedMaskMass a 90136 (-25897446) + (weightedMaskMass a 53314 (13771949) +
        -weightedMaskMass a 1073176 (13771949))) + ((weightedMaskMass a 53504 (31110524) +
        -weightedMaskMass a 77826 (31110524)) + (weightedMaskMass a 53506 (18798992) +
        -weightedMaskMass a 77858 (18798992))))))) + (((((weightedMaskMass a 53508 (22579475) +
        (-weightedMaskMass a 77890 (22579475) + weightedMaskMass a 57344 (83321703))) +
        (-weightedMaskMass a 163904 (83321703) + (weightedMaskMass a 57344 (-128718027) +
        -weightedMaskMass a 557184 (-128718027)))) + ((weightedMaskMass a 57344 (-24508707) +
        (-weightedMaskMass a 3407872 (-24508707) + weightedMaskMass a 57344 (24611074))) +
        (-weightedMaskMass a 4227136 (24611074) + (weightedMaskMass a 57344 (51143511) +
        -weightedMaskMass a 4718600 (51143511))))) + (((weightedMaskMass a 57345 (55449208) +
        (-weightedMaskMass a 2261056 (55449208) + weightedMaskMass a 57345 (-20556153))) +
        (-weightedMaskMass a 4229184 (-20556153) + (weightedMaskMass a 57346 (-25224760) +
        -weightedMaskMass a 622720 (-25224760)))) + ((weightedMaskMass a 57348 (112920330) +
        (-weightedMaskMass a 1605760 (112920330) + weightedMaskMass a 57348 (-89112348))) +
        ((-weightedMaskMass a 3408384 (-89112348) + weightedMaskMass a 57352 (76854310)) +
        (-weightedMaskMass a 180288 (76854310) + weightedMaskMass a 57353 (-87005746)))))) +
        ((((-weightedMaskMass a 2277440 (-87005746) + (weightedMaskMass a 57360 (13879205) +
        -weightedMaskMass a 168000 (13879205))) + (weightedMaskMass a 57368 (-59925454) +
        (-weightedMaskMass a 184384 (-59925454) + weightedMaskMass a 57600 (18544664)))) +
        ((-weightedMaskMass a 229440 (18544664) + (weightedMaskMass a 57600 (119330197) +
        -weightedMaskMass a 557188 (119330197))) + (weightedMaskMass a 57600 (-3604730) +
        (-weightedMaskMass a 3407880 (-3604730) + weightedMaskMass a 57600 (-27043108))))) +
        (((-weightedMaskMass a 5767176 (-27043108) + (weightedMaskMass a 57602 (-4031640) +
        -weightedMaskMass a 622724 (-4031640))) + (weightedMaskMass a 57604 (-191524668) +
        (-weightedMaskMass a 1605764 (-191524668) + weightedMaskMass a 57604 (98351167)))) +
        ((-weightedMaskMass a 3408392 (98351167) + (weightedMaskMass a 57608 (-119286888) +
        -weightedMaskMass a 245824 (-119286888))) + ((weightedMaskMass a 57616 (-42604293) +
        -weightedMaskMass a 233536 (-42604293)) + (weightedMaskMass a 57624 (33275052) +
        -weightedMaskMass a 249920 (33275052))))))))) := by
