...
theorem congruenceBlock06_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt06 s.val : ℝ)) = (((((((weightedMaskMass a 8482
        (117946394) + (-weightedMaskMass a 3672064 (117946394) + weightedMaskMass a 8484
        (-105468340))) + (-weightedMaskMass a 24612 (-105468340) + (weightedMaskMass a 8484
        (42184464) + -weightedMaskMass a 34948 (42184464)))) + ((weightedMaskMass a 8484 (81339673)
        + (-weightedMaskMass a 1573384 (81339673) + weightedMaskMass a 8484 (54923612))) +
        (-weightedMaskMass a 3670528 (54923612) + (weightedMaskMass a 8488 (-2513039) +
        -weightedMaskMass a 3686400 (-2513039))))) + (((weightedMaskMass a 8713 (-36656385) +
        (-weightedMaskMass a 606212 (-36656385) + weightedMaskMass a 8713 (-86460639))) +
        (-weightedMaskMass a 2146320 (-86460639) + (weightedMaskMass a 8736 (-51876611) +
        -weightedMaskMass a 16656 (-51876611)))) + ((weightedMaskMass a 8736 (11680769) +
        (-weightedMaskMass a 33028 (11680769) + weightedMaskMass a 8736 (-30383746))) +
        ((-weightedMaskMass a 69696 (-30383746) + weightedMaskMass a 8736 (-42942289)) +
        (-weightedMaskMass a 135170 (-42942289) + weightedMaskMass a 8736 (-13510000)))))) +
        ((((-weightedMaskMass a 262664 (-13510000) + (weightedMaskMass a 8736 (-19445780) +
        -weightedMaskMass a 1081360 (-19445780))) + (weightedMaskMass a 8736 (-41691540) +
        (-weightedMaskMass a 1572868 (-41691540) + weightedMaskMass a 8738 (-94513844)))) +
        ((-weightedMaskMass a 16658 (-94513844) + (weightedMaskMass a 8738 (21132814) +
        -weightedMaskMass a 135202 (21132814))) + (weightedMaskMass a 8738 (78486492) +
        (-weightedMaskMass a 1083408 (78486492) + weightedMaskMass a 8738 (86711789))))) +
        (((-weightedMaskMass a 1574916 (86711789) + (weightedMaskMass a 8740 (31594331) +
        -weightedMaskMass a 35076 (31594331))) + (weightedMaskMass a 8740 (-29886867) +
        (-weightedMaskMass a 1081362 (-29886867) + weightedMaskMass a 8740 (31251698)))) +
        ((-weightedMaskMass a 1573380 (31251698) + (weightedMaskMass a 8744 (95393274) +
        -weightedMaskMass a 262696 (95393274))) + ((weightedMaskMass a 8744 (-22779014) +
        -weightedMaskMass a 1589252 (-22779014)) + (weightedMaskMass a 16660 (-8809710) +
        -weightedMaskMass a 135234 (-8809710))))))) + (((((weightedMaskMass a 16660 (19862691) +
        (-weightedMaskMass a 1081604 (19862691) + weightedMaskMass a 16660 (17252909))) +
        (-weightedMaskMass a 1097744 (17252909) + (weightedMaskMass a 8768 (-51904005) +
        -weightedMaskMass a 294920 (-51904005)))) + ((weightedMaskMass a 8768 (-88039468) +
        (-weightedMaskMass a 525376 (-88039468) + weightedMaskMass a 8768 (-14971146))) +
        (-weightedMaskMass a 5242912 (-14971146) + (weightedMaskMass a 8770 (45253726) +
        -weightedMaskMass a 5243424 (45253726))))) + (((weightedMaskMass a 151556 (-103460622) +
        (-weightedMaskMass a 528452 (-103460622) + weightedMaskMass a 151556 (112089053))) +
        (-weightedMaskMass a 2098752 (112089053) + (weightedMaskMass a 8772 (-79057483) +
        -weightedMaskMass a 527424 (-79057483)))) + ((weightedMaskMass a 8964 (42904103) +
        (-weightedMaskMass a 2621956 (42904103) + weightedMaskMass a 8968 (-118595457))) +
        ((-weightedMaskMass a 114704 (-118595457) + weightedMaskMass a 8968 (-23752685)) +
        (-weightedMaskMass a 135233 (-23752685) + weightedMaskMass a 8968 (110128344)))))) +
        ((((-weightedMaskMass a 2637828 (110128344) + (weightedMaskMass a 8992 (-8587632) +
        -weightedMaskMass a 24848 (-8587632))) + (weightedMaskMass a 8992 (329553) +
        (-weightedMaskMass a 102464 (329553) + weightedMaskMass a 8992 (125319442)))) +
        ((-weightedMaskMass a 3670020 (125319442) + (weightedMaskMass a 8994 (-389031) +
        -weightedMaskMass a 24850 (-389031))) + (weightedMaskMass a 8994 (-195766498) +
        (-weightedMaskMass a 3672068 (-195766498) + weightedMaskMass a 8996 (-52211010))))) +
        (((-weightedMaskMass a 3670532 (-52211010) + (weightedMaskMass a 9000 (-28809595) +
        -weightedMaskMass a 3686404 (-28809595))) + (weightedMaskMass a 9232 (-11156654) +
        (-weightedMaskMass a 38912 (-11156654) + weightedMaskMass a 9232 (-26985920)))) +
        ((-weightedMaskMass a 264196 (-26985920) + (weightedMaskMass a 9232 (-71659654) +
        -weightedMaskMass a 268288 (-71659654))) + ((weightedMaskMass a 9232 (40526868) +
        -weightedMaskMass a 528385 (40526868)) + (weightedMaskMass a 9232 (14617654) +
        -weightedMaskMass a 2228228 (14617654)))))))) + ((((((weightedMaskMass a 9234 (20539495) +
        (-weightedMaskMass a 264212 (20539495) + weightedMaskMass a 9234 (-51160985))) +
        (-weightedMaskMass a 268320 (-51160985) + (weightedMaskMass a 9234 (-45566307) +
        -weightedMaskMass a 544769 (-45566307)))) + ((weightedMaskMass a 9234 (47231875) +
        (-weightedMaskMass a 563200 (47231875) + weightedMaskMass a 9234 (-60794216))) +
        (-weightedMaskMass a 2228292 (-60794216) + (weightedMaskMass a 9236 (-7322105) +
        -weightedMaskMass a 264228 (-7322105))))) + (((weightedMaskMass a 9236 (-45069380) +
        (-weightedMaskMass a 2228260 (-45069380) + weightedMaskMass a 9280 (75376785))) +
        (-weightedMaskMass a 135172 (75376785) + (weightedMaskMass a 9280 (45209722) +
        -weightedMaskMass a 294928 (45209722)))) + ((weightedMaskMass a 9280 (9480028) +
        (-weightedMaskMass a 327688 (9480028) + weightedMaskMass a 9280 (-55102951))) +
        ((-weightedMaskMass a 331776 (-55102951) + weightedMaskMass a 9280 (-134505344)) +
        (-weightedMaskMass a 525316 (-134505344) + weightedMaskMass a 9280 (160157043)))))) +
        ((((-weightedMaskMass a 528388 (160157043) + (weightedMaskMass a 9280 (-104362161) +
        -weightedMaskMass a 2098240 (-104362161))) + (weightedMaskMass a 9280 (-34237020) +
        (-weightedMaskMass a 5242882 (-34237020) + weightedMaskMass a 9281 (-18359348)))) +
        ((-weightedMaskMass a 348160 (-18359348) + (weightedMaskMass a 9282 (-67946115) +
        -weightedMaskMass a 135236 (-67946115))) + (weightedMaskMass a 9282 (20045920) +
        (-weightedMaskMass a 544772 (20045920) + weightedMaskMass a 9284 (-50719729))))) +
        (((-weightedMaskMass a 135204 (-50719729) + (weightedMaskMass a 9284 (59311757) +
        -weightedMaskMass a 527364 (59311757))) + (weightedMaskMass a 9284 (-30254247) +
        (-weightedMaskMass a 5243394 (-30254247) + weightedMaskMass a 9729 (14804630)))) +
        ((-weightedMaskMass a 2131984 (14804630) + (weightedMaskMass a 9730 (-59011210) +
        -weightedMaskMass a 397344 (-59011210))) + ((weightedMaskMass a 9792 (1484124) +
        -weightedMaskMass a 294936 (1484124)) + (weightedMaskMass a 9792 (84399971) +
        -weightedMaskMass a 525380 (84399971))))))) + (((((weightedMaskMass a 9796 (69931264) +
        (-weightedMaskMass a 527428 (69931264) + weightedMaskMass a 12292 (12245690))) +
        (-weightedMaskMass a 4325408 (12245690) + (weightedMaskMass a 12296 (62563955) +
        -weightedMaskMass a 4849664 (62563955)))) + ((weightedMaskMass a 12322 (-12964826) +
        (-weightedMaskMass a 20738 (-12964826) + weightedMaskMass a 12354 (7938939))) +
        (-weightedMaskMass a 20740 (7938939) + (weightedMaskMass a 12576 (-8125297) +
        -weightedMaskMass a 28928 (-8125297))))) + (((weightedMaskMass a 12578 (32442482) +
        (-weightedMaskMass a 28930 (32442482) + weightedMaskMass a 13312 (-50127171))) +
        (-weightedMaskMass a 274432 (-50127171) + (weightedMaskMass a 13312 (94911324) +
        -weightedMaskMass a 528640 (94911324)))) + ((weightedMaskMass a 13312 (-27252032) +
        (-weightedMaskMass a 4325380 (-27252032) + weightedMaskMass a 274433 (-22216042))) +
        ((-weightedMaskMass a 530688 (-22216042) + weightedMaskMass a 13314 (9334311)) +
        (-weightedMaskMass a 274464 (9334311) + weightedMaskMass a 13314 (-51369275)))))) +
        ((((-weightedMaskMass a 545024 (-51369275) + (weightedMaskMass a 13316 (-8159914) +
        -weightedMaskMass a 4325412 (-8159914))) + (weightedMaskMass a 13376 (-102238879) +
        (-weightedMaskMass a 528644 (-102238879) + weightedMaskMass a 13378 (1596693)))) +
        ((-weightedMaskMass a 545028 (1596693) + (weightedMaskMass a 16392 (-107002353) +
        -weightedMaskMass a 16448 (-107002353))) + (weightedMaskMass a 16393 (54775580) +
        (-weightedMaskMass a 16449 (54775580) + weightedMaskMass a 16393 (-150242554))))) +
        (((-weightedMaskMass a 81928 (-150242554) + (weightedMaskMass a 16393 (182137931) +
        -weightedMaskMass a 2113600 (182137931))) + (weightedMaskMass a 16408 (92266622) +
        (-weightedMaskMass a 16452 (92266622) + weightedMaskMass a 16408 (5730072)))) +
        ((-weightedMaskMass a 20544 (5730072) + (weightedMaskMass a 16418 (-98837320) +
        -weightedMaskMass a 1050632 (-98837320))) + ((weightedMaskMass a 16424 (62452433) +
        -weightedMaskMass a 16450 (62452433)) + (weightedMaskMass a 16424 (-30305784) +
        -weightedMaskMass a 1064968 (-30305784))))))))) := by
