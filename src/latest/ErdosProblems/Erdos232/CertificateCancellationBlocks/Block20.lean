...
theorem congruenceBlock20_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt20 s.val : ℝ)) = (((((((weightedMaskMass a 1180196
        (-30575976) + (-weightedMaskMass a 3146306 (-30575976) + weightedMaskMass a 1180416
        (10592380))) + (-weightedMaskMass a 3276864 (10592380) + (weightedMaskMass a 1180420
        (-10592380) + -weightedMaskMass a 3276866 (-10592380)))) + ((weightedMaskMass a 1180448
        (148013) + (-weightedMaskMass a 3277376 (148013) + weightedMaskMass a 1180452 (-39198761)))
        + (-weightedMaskMass a 3277378 (-39198761) + (weightedMaskMass a 1183745 (50600853) +
        -weightedMaskMass a 5244992 (50600853))))) + (((weightedMaskMass a 1183748 (21801661) +
        (-weightedMaskMass a 5242946 (21801661) + weightedMaskMass a 1183776 (-11736340))) +
        (-weightedMaskMass a 5243456 (-11736340) + (weightedMaskMass a 1183780 (-12422963) +
        -weightedMaskMass a 5243458 (-12422963)))) + ((weightedMaskMass a 1183808 (-28293344) +
        (-weightedMaskMass a 1212672 (-28293344) + weightedMaskMass a 1183810 (6717448))) +
        ((-weightedMaskMass a 1212676 (6717448) + weightedMaskMass a 1184000 (23539081)) +
        (-weightedMaskMass a 5374016 (23539081) + weightedMaskMass a 1184004 (-8480578)))))) +
        ((((-weightedMaskMass a 5374018 (-8480578) + (weightedMaskMass a 1184032 (-10942881) +
        -weightedMaskMass a 5374528 (-10942881))) + (weightedMaskMass a 1184036 (15373121) +
        (-weightedMaskMass a 5374530 (15373121) + weightedMaskMass a 1216512 (66646338)))) +
        ((-weightedMaskMass a 5247040 (66646338) + (weightedMaskMass a 1216513 (-78443850) +
        -weightedMaskMass a 5249088 (-78443850))) + (weightedMaskMass a 1216516 (-63779195) +
        (-weightedMaskMass a 5247042 (-63779195) + weightedMaskMass a 1216768 (-30272319))))) +
        (((-weightedMaskMass a 5378112 (-30272319) + (weightedMaskMass a 1216772 (27619567) +
        -weightedMaskMass a 5378114 (27619567))) + (weightedMaskMass a 1310740 (21901721) +
        (-weightedMaskMass a 1609728 (21901721) + weightedMaskMass a 1310848 (0)))) +
        ((-weightedMaskMass a 1314816 (0) + (weightedMaskMass a 1310852 (18631764) +
        -weightedMaskMass a 1312896 (18631764))) + ((weightedMaskMass a 1310884 (25525729) +
        -weightedMaskMass a 1312928 (25525729)) + (weightedMaskMass a 1311268 (-4328096) +
        -weightedMaskMass a 1589377 (-4328096))))))) + (((((weightedMaskMass a 1311272 (11919480) +
        (-weightedMaskMass a 1589380 (11919480) + weightedMaskMass a 1312776 (-39952689))) +
        (-weightedMaskMass a 5244936 (-39952689) + (weightedMaskMass a 1312788 (-29196340) +
        -weightedMaskMass a 1611776 (-29196340)))) + ((weightedMaskMass a 1312808 (-62735147) +
        (-weightedMaskMass a 5277704 (-62735147) + weightedMaskMass a 1314820 (-7850155))) +
        (-weightedMaskMass a 1347584 (-7850155) + (weightedMaskMass a 1316868 (44572367) +
        -weightedMaskMass a 1349632 (44572367))))) + (((weightedMaskMass a 1318912 (28565819) +
        (-weightedMaskMass a 2138112 (28565819) + weightedMaskMass a 1318913 (-19517167))) +
        (-weightedMaskMass a 2138114 (-19517167) + (weightedMaskMass a 1318928 (-25903622) +
        -weightedMaskMass a 2138116 (-25903622)))) + ((weightedMaskMass a 1318944 (-13385218) +
        (-weightedMaskMass a 2138120 (-13385218) + weightedMaskMass a 1319168 (-19399459))) +
        ((-weightedMaskMass a 2662400 (-19399459) + weightedMaskMass a 1319184 (254608)) +
        (-weightedMaskMass a 2662404 (254608) + weightedMaskMass a 1319200 (29458696)))))) +
        ((((-weightedMaskMass a 2662408 (29458696) + (weightedMaskMass a 1327360 (240338685) +
        -weightedMaskMass a 1613824 (240338685))) + (weightedMaskMass a 1327376 (-213702314) +
        (-weightedMaskMass a 1613828 (-213702314) + weightedMaskMass a 1327392 (-196781006)))) +
        ((-weightedMaskMass a 1613832 (-196781006) + (weightedMaskMass a 1335296 (-22426791) +
        -weightedMaskMass a 3186688 (-22426791))) + (weightedMaskMass a 1335297 (83781935) +
        (-weightedMaskMass a 3186690 (83781935) + weightedMaskMass a 1335312 (52374056))))) +
        (((-weightedMaskMass a 3186692 (52374056) + (weightedMaskMass a 1335328 (33776717) +
        -weightedMaskMass a 3186696 (33776717))) + (weightedMaskMass a 1335552 (-22752166) +
        (-weightedMaskMass a 3710976 (-22752166) + weightedMaskMass a 1335568 (44253150)))) +
        ((-weightedMaskMass a 3710980 (44253150) + (weightedMaskMass a 1335584 (2906526) +
        -weightedMaskMass a 3710984 (2906526))) + ((weightedMaskMass a 1343496 (-30952239) +
        -weightedMaskMass a 5242920 (-30952239)) + (weightedMaskMass a 1343504 (33330650) +
        -weightedMaskMass a 1576964 (33330650)))))))) + ((((((weightedMaskMass a 1343508 (-20440694)
        + (-weightedMaskMass a 1609732 (-20440694) + weightedMaskMass a 1345544 (120418658))) +
        (-weightedMaskMass a 5244968 (120418658) + (weightedMaskMass a 1345552 (-30038422) +
        -weightedMaskMass a 1579012 (-30038422)))) + ((weightedMaskMass a 1345556 (55260402) +
        (-weightedMaskMass a 1611780 (55260402) + weightedMaskMass a 1572884 (7443141))) +
        (-weightedMaskMass a 1605648 (7443141) + (weightedMaskMass a 1572888 (12131394) +
        -weightedMaskMass a 3670032 (12131394))))) + (((weightedMaskMass a 1573128 (270602205) +
        (-weightedMaskMass a 2121760 (270602205) + weightedMaskMass a 1573136 (13815631))) +
        (-weightedMaskMass a 5767184 (13815631) + (weightedMaskMass a 1573152 (104472915) +
        -weightedMaskMass a 3153952 (104472915)))) + ((weightedMaskMass a 1573156 (-186621933) +
        (-weightedMaskMass a 3154464 (-186621933) + weightedMaskMass a 1573160 (-87283336))) +
        ((-weightedMaskMass a 3170336 (-87283336) + weightedMaskMass a 1573636 (-175073804)) +
        (-weightedMaskMass a 2105892 (-175073804) + weightedMaskMass a 1573640 (-201236435)))))) +
        ((((-weightedMaskMass a 2121764 (-201236435) + (weightedMaskMass a 1573664 (-159771601) +
        -weightedMaskMass a 3153956 (-159771601))) + (weightedMaskMass a 1573668 (289813940) +
        (-weightedMaskMass a 3154468 (289813940) + weightedMaskMass a 1573672 (79531703)))) +
        ((-weightedMaskMass a 3170340 (79531703) + (weightedMaskMass a 1574932 (-38140977) +
        -weightedMaskMass a 1607696 (-38140977))) + (weightedMaskMass a 1575172 (42595847) +
        (-weightedMaskMass a 2105890 (42595847) + weightedMaskMass a 1575176 (-42606420))))) +
        (((-weightedMaskMass a 2121762 (-42606420) + (weightedMaskMass a 1575200 (63124945) +
        -weightedMaskMass a 3153954 (63124945))) + (weightedMaskMass a 1575204 (98398450) +
        (-weightedMaskMass a 3154466 (98398450) + weightedMaskMass a 1575208 (-135405831)))) +
        ((-weightedMaskMass a 3170338 (-135405831) + (weightedMaskMass a 1576961 (-33502192) +
        -weightedMaskMass a 2260996 (-33502192))) + ((weightedMaskMass a 1576968 (-87625142) +
        -weightedMaskMass a 3670144 (-87625142)) + (weightedMaskMass a 1577216 (4723518) +
        -weightedMaskMass a 4358148 (4723518))))))) + (((((weightedMaskMass a 1581092 (-92639459) +
        (-weightedMaskMass a 1581600 (-92639459) + weightedMaskMass a 1581096 (13415619))) +
        (-weightedMaskMass a 1597472 (13415619) + (weightedMaskMass a 1581312 (194849800) +
        -weightedMaskMass a 2629664 (194849800)))) + ((weightedMaskMass a 1581316 (-121522078) +
        (-weightedMaskMass a 2630176 (-121522078) + weightedMaskMass a 1581320 (-196584522))) +
        (-weightedMaskMass a 2646048 (-196584522) + (weightedMaskMass a 1581344 (-274185038) +
        -weightedMaskMass a 3678240 (-274185038))))) + (((weightedMaskMass a 1581348 (592177530) +
        (-weightedMaskMass a 3678752 (592177530) + weightedMaskMass a 1581352 (163285760))) +
        (-weightedMaskMass a 3694624 (163285760) + (weightedMaskMass a 1581608 (-183227571) +
        -weightedMaskMass a 1597476 (-183227571)))) + ((weightedMaskMass a 1581824 (-146899229) +
        (-weightedMaskMass a 2629668 (-146899229) + weightedMaskMass a 1581828 (44910821))) +
        ((-weightedMaskMass a 2630180 (44910821) + weightedMaskMass a 1581832 (45698360)) +
        (-weightedMaskMass a 2646052 (45698360) + weightedMaskMass a 1581856 (237810731)))))) +
        ((((-weightedMaskMass a 3678244 (237810731) + (weightedMaskMass a 1581860 (-473409367) +
        -weightedMaskMass a 3678756 (-473409367))) + (weightedMaskMass a 1581864 (0) +
        (-weightedMaskMass a 3694628 (0) + weightedMaskMass a 1589504 (14080709)))) +
        ((-weightedMaskMass a 2105384 (14080709) + (weightedMaskMass a 1589508 (29244388) +
        -weightedMaskMass a 2105896 (29244388))) + (weightedMaskMass a 1589512 (-27820592) +
        (-weightedMaskMass a 2121768 (-27820592) + weightedMaskMass a 1589536 (-339002536))))) +
        (((-weightedMaskMass a 3153960 (-339002536) + (weightedMaskMass a 1589540 (241284083) +
        -weightedMaskMass a 3154472 (241284083))) + (weightedMaskMass a 1589544 (298939962) +
        (-weightedMaskMass a 3170344 (298939962) + weightedMaskMass a 1597696 (-36606053)))) +
        ((-weightedMaskMass a 2629672 (-36606053) + (weightedMaskMass a 1597700 (136028113) +
        -weightedMaskMass a 2630184 (136028113))) + ((weightedMaskMass a 1597704 (2885197) +
        -weightedMaskMass a 2646056 (2885197)) + (weightedMaskMass a 1597728 (446043324) +
        -weightedMaskMass a 3678248 (446043324))))))))) := by
