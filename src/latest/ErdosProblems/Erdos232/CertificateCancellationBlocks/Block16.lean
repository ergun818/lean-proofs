...
theorem congruenceBlock16_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt16 s.val : ℝ)) = (((((((weightedMaskMass a 345089
        (-81518734) + (-weightedMaskMass a 2376705 (-81518734) + weightedMaskMass a 345092
        (58055786))) + (-weightedMaskMass a 2376720 (58055786) + (weightedMaskMass a 345104
        (-227587375) + -weightedMaskMass a 2376708 (-227587375)))) + ((weightedMaskMass a 345108
        (-39404760) + (-weightedMaskMass a 2376724 (-39404760) + weightedMaskMass a 360448
        (-29783029))) + (-weightedMaskMass a 2622464 (-29783029) + (weightedMaskMass a 360448
        (37974092) + -weightedMaskMass a 4194338 (37974092))))) + (((weightedMaskMass a 360449
        (27557619) + (-weightedMaskMass a 2622465 (27557619) + weightedMaskMass a 360452 (1865106)))
        + (-weightedMaskMass a 2622480 (1865106) + (weightedMaskMass a 360452 (45591035) +
        -weightedMaskMass a 4198434 (45591035)))) + ((weightedMaskMass a 360456 (45249341) +
        (-weightedMaskMass a 2622528 (45249341) + weightedMaskMass a 360456 (-10733195))) +
        ((-weightedMaskMass a 5242914 (-10733195) + weightedMaskMass a 360457 (-53229344)) +
        (-weightedMaskMass a 2622529 (-53229344) + weightedMaskMass a 360464 (750150)))))) +
        ((((-weightedMaskMass a 364544 (750150) + (weightedMaskMass a 360464 (76021459) +
        -weightedMaskMass a 2622468 (76021459))) + (weightedMaskMass a 360468 (-45035625) +
        (-weightedMaskMass a 2622484 (-45035625) + weightedMaskMass a 360472 (-84936028)))) +
        ((-weightedMaskMass a 2622532 (-84936028) + (weightedMaskMass a 376832 (205219826) +
        -weightedMaskMass a 2638848 (205219826))) + (weightedMaskMass a 376833 (-146483913) +
        (-weightedMaskMass a 2638849 (-146483913) + weightedMaskMass a 376836 (-80581880))))) +
        (((-weightedMaskMass a 2638864 (-80581880) + (weightedMaskMass a 376840 (-193660215) +
        -weightedMaskMass a 2638912 (-193660215))) + (weightedMaskMass a 376841 (132425952) +
        (-weightedMaskMass a 2638913 (132425952) + weightedMaskMass a 376848 (-429910775)))) +
        ((-weightedMaskMass a 2638852 (-429910775) + (weightedMaskMass a 376852 (356164466) +
        -weightedMaskMass a 2638868 (356164466))) + ((weightedMaskMass a 376856 (387887946) +
        -weightedMaskMass a 2638916 (387887946)) + (weightedMaskMass a 393344 (0) +
        -weightedMaskMass a 1052704 (0))))))) + (((((weightedMaskMass a 393344 (-1469047) +
        (-weightedMaskMass a 4194880 (-1469047) + weightedMaskMass a 393345 (-17902422))) +
        (-weightedMaskMass a 1069088 (-17902422) + (weightedMaskMass a 393348 (5866000) +
        -weightedMaskMass a 1054752 (5866000)))) + ((weightedMaskMass a 393376 (-16974608) +
        (-weightedMaskMass a 4719168 (-16974608) + weightedMaskMass a 393732 (61508937))) +
        (-weightedMaskMass a 589848 (61508937) + (weightedMaskMass a 393732 (-55610079) +
        -weightedMaskMass a 2129988 (-55610079))))) + (((weightedMaskMass a 393736 (14443013) +
        (-weightedMaskMass a 3178512 (14443013) + weightedMaskMass a 397320 (-18940515))) +
        (-weightedMaskMass a 720900 (-18940515) + (weightedMaskMass a 409604 (7937264) +
        -weightedMaskMass a 530496 (7937264)))) + ((weightedMaskMass a 409604 (-683662) +
        (-weightedMaskMass a 2097732 (-683662) + weightedMaskMass a 413697 (99138126))) +
        ((-weightedMaskMass a 2623556 (99138126) + weightedMaskMass a 413700 (152194145)) +
        (-weightedMaskMass a 530500 (152194145) + weightedMaskMass a 413700 (-163295084)))))) +
        ((((-weightedMaskMass a 2098756 (-163295084) + (weightedMaskMass a 458760 (-3995125) +
        -weightedMaskMass a 593924 (-3995125))) + (weightedMaskMass a 462856 (6925759) +
        (-weightedMaskMass a 724996 (6925759) + weightedMaskMass a 524552 (-96178631)))) +
        ((-weightedMaskMass a 2121728 (-96178631) + (weightedMaskMass a 524580 (107171119) +
        -weightedMaskMass a 3154432 (107171119))) + (weightedMaskMass a 524584 (106862441) +
        (-weightedMaskMass a 3170304 (106862441) + weightedMaskMass a 525064 (-19181964))))) +
        (((-weightedMaskMass a 2121732 (-19181964) + (weightedMaskMass a 525092 (-120672407) +
        -weightedMaskMass a 3154436 (-120672407))) + (weightedMaskMass a 525096 (-13430035) +
        (-weightedMaskMass a 3170308 (-13430035) + weightedMaskMass a 525825 (53584324)))) +
        ((-weightedMaskMass a 2100240 (53584324) + (weightedMaskMass a 525828 (-160809205) +
        -weightedMaskMass a 528420 (-160809205))) + ((weightedMaskMass a 525828 (58999136) +
        -weightedMaskMass a 2100288 (58999136)) + (weightedMaskMass a 526401 (101593637) +
        -weightedMaskMass a 2506752 (101593637)))))))) + ((((((weightedMaskMass a 526468 (-79618608)
        + (-weightedMaskMass a 5243400 (-79618608) + weightedMaskMass a 526596 (97974831))) +
        (-weightedMaskMass a 2105858 (97974831) + (weightedMaskMass a 526596 (-71311610) +
        -weightedMaskMass a 5243396 (-71311610)))) + ((weightedMaskMass a 526600 (96178631) +
        (-weightedMaskMass a 2121730 (96178631) + weightedMaskMass a 526628 (-141664647))) +
        (-weightedMaskMass a 3154434 (-141664647) + (weightedMaskMass a 526632 (-127493217) +
        -weightedMaskMass a 3170306 (-127493217))))) + (((weightedMaskMass a 528392 (-20522264) +
        (-weightedMaskMass a 655872 (-20522264) + weightedMaskMass a 528392 (-67489199))) +
        (-weightedMaskMass a 2097344 (-67489199) + (weightedMaskMass a 528392 (54214426) +
        -weightedMaskMass a 3145856 (54214426)))) + ((weightedMaskMass a 528424 (29573944) +
        (-weightedMaskMass a 2099392 (29573944) + weightedMaskMass a 528449 (9971524))) +
        ((-weightedMaskMass a 2244612 (9971524) + weightedMaskMass a 529412 (123679897)) +
        (-weightedMaskMass a 2106432 (123679897) + weightedMaskMass a 529472 (98194451)))))) +
        ((((-weightedMaskMass a 2105920 (98194451) + (weightedMaskMass a 529472 (51564325) +
        -weightedMaskMass a 5242916 (51564325))) + (weightedMaskMass a 529476 (-95464995) +
        (-weightedMaskMass a 2106944 (-95464995) + weightedMaskMass a 530440 (14911091)))) +
        ((-weightedMaskMass a 655873 (14911091) + (weightedMaskMass a 530440 (-3153924) +
        -weightedMaskMass a 2097348 (-3153924))) + (weightedMaskMass a 530468 (-122889273) +
        (-weightedMaskMass a 2100292 (-122889273) + weightedMaskMass a 530472 (2655941))))) +
        (((-weightedMaskMass a 2099396 (2655941) + (weightedMaskMass a 530497 (-71299771) +
        -weightedMaskMass a 2506756 (-71299771))) + (weightedMaskMass a 531456 (136320069) +
        (-weightedMaskMass a 2105412 (136320069) + weightedMaskMass a 531460 (-157377788)))) +
        ((-weightedMaskMass a 2106436 (-157377788) + (weightedMaskMass a 531520 (-134589361) +
        -weightedMaskMass a 2105924 (-134589361))) + ((weightedMaskMass a 531524 (199137167) +
        -weightedMaskMass a 2106948 (199137167)) + (weightedMaskMass a 532489 (-101106595) +
        -weightedMaskMass a 614400 (-101106595))))))) + (((((weightedMaskMass a 532516 (45809088) +
        (-weightedMaskMass a 1581568 (45809088) + weightedMaskMass a 532520 (64125608))) +
        (-weightedMaskMass a 1597440 (64125608) + (weightedMaskMass a 532544 (-69413267) +
        -weightedMaskMass a 4194464 (-69413267)))) + ((weightedMaskMass a 532740 (124771958) +
        (-weightedMaskMass a 2630144 (124771958) + weightedMaskMass a 532740 (-63849989))) +
        (-weightedMaskMass a 5243012 (-63849989) + (weightedMaskMass a 532744 (25430570) +
        -weightedMaskMass a 2646016 (25430570))))) + (((weightedMaskMass a 532772 (-164488091) +
        (-weightedMaskMass a 3678720 (-164488091) + weightedMaskMass a 532776 (-100641207))) +
        (-weightedMaskMass a 3694592 (-100641207) + (weightedMaskMass a 533000 (-113992140) +
        -weightedMaskMass a 548868 (-113992140)))) + ((weightedMaskMass a 533000 (-52818984) +
        (-weightedMaskMass a 5275776 (-52818984) + weightedMaskMass a 533001 (260531065))) +
        ((-weightedMaskMass a 614404 (260531065) + weightedMaskMass a 533028 (-28971390)) +
        (-weightedMaskMass a 1581572 (-28971390) + weightedMaskMass a 533032 (69672297)))))) +
        ((((-weightedMaskMass a 1597444 (69672297) + (weightedMaskMass a 533056 (66433737) +
        -weightedMaskMass a 5243040 (66433737))) + (weightedMaskMass a 533252 (-61809067) +
        (-weightedMaskMass a 2630148 (-61809067) + weightedMaskMass a 533256 (127315994)))) +
        ((-weightedMaskMass a 2646020 (127315994) + (weightedMaskMass a 533284 (133570209) +
        -weightedMaskMass a 3678724 (133570209))) + (weightedMaskMass a 533288 (-30177168) +
        (-weightedMaskMass a 3694596 (-30177168) + weightedMaskMass a 533504 (7459639))))) +
        (((-weightedMaskMass a 4194434 (7459639) + (weightedMaskMass a 533508 (-34366992) +
        -weightedMaskMass a 5243010 (-34366992))) + (weightedMaskMass a 540804 (17761082) +
        (-weightedMaskMass a 1310760 (17761082) + weightedMaskMass a 540804 (94830295)))) +
        ((-weightedMaskMass a 5275656 (94830295) + (weightedMaskMass a 540936 (104381524) +
        -weightedMaskMass a 2121736 (104381524))) + ((weightedMaskMass a 540964 (-256038076) +
        -weightedMaskMass a 3154440 (-256038076)) + (weightedMaskMass a 540968 (-254853616) +
        -weightedMaskMass a 3170312 (-254853616))))))))) := by
