...
theorem congruenceBlock18_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt18 s.val : ℝ)) = (((((((weightedMaskMass a 606276
        (51622852) + (-weightedMaskMass a 2146328 (51622852) + weightedMaskMass a 606464
        (210635350))) + (-weightedMaskMass a 2105353 (210635350) + (weightedMaskMass a 606468
        (-84188822) + -weightedMaskMass a 2105865 (-84188822)))) + ((weightedMaskMass a 606472
        (-161018958) + (-weightedMaskMass a 2121737 (-161018958) + weightedMaskMass a 606496
        (-398781337))) + (-weightedMaskMass a 3153929 (-398781337) + (weightedMaskMass a 606500
        (260335992) + -weightedMaskMass a 3154441 (260335992))))) + (((weightedMaskMass a 606504
        (346308501) + (-weightedMaskMass a 3170313 (346308501) + weightedMaskMass a 607232
        (64394214))) + (-weightedMaskMass a 2408448 (64394214) + (weightedMaskMass a 607233
        (-81663157) + -weightedMaskMass a 2408449 (-81663157)))) + ((weightedMaskMass a 607236
        (102039482) + (-weightedMaskMass a 2408464 (102039482) + weightedMaskMass a 607248
        (-229298011))) + ((-weightedMaskMass a 2408452 (-229298011) + weightedMaskMass a 607252
        (-54328949)) + (-weightedMaskMass a 2408468 (-54328949) + weightedMaskMass a 607296
        (-183264630)))))) + ((((-weightedMaskMass a 2408456 (-183264630) + (weightedMaskMass a
        607297 (273256547) + -weightedMaskMass a 2408457 (273256547))) + (weightedMaskMass a 607300
        (104254742) + (-weightedMaskMass a 2408472 (104254742) + weightedMaskMass a 614432
        (-138208139)))) + ((-weightedMaskMass a 1581065 (-138208139) + (weightedMaskMass a 614436
        (307558809) + -weightedMaskMass a 1581577 (307558809))) + (weightedMaskMass a 614440
        (5534556) + (-weightedMaskMass a 1597449 (5534556) + weightedMaskMass a 614656
        (-146211714))))) + (((-weightedMaskMass a 2629641 (-146211714) + (weightedMaskMass a 614660
        (213598490) + -weightedMaskMass a 2630153 (213598490))) + (weightedMaskMass a 614664
        (117638519) + (-weightedMaskMass a 2646025 (117638519) + weightedMaskMass a 614688
        (326213125)))) + ((-weightedMaskMass a 3678217 (326213125) + (weightedMaskMass a 614692
        (-389786728) + -weightedMaskMass a 3678729 (-389786728))) + ((weightedMaskMass a 614696
        (-278457306) + -weightedMaskMass a 3694601 (-278457306)) + (weightedMaskMass a 622593
        (34595748) + -weightedMaskMass a 2654209 (34595748))))))) + (((((weightedMaskMass a 622601
        (-104246922) + (-weightedMaskMass a 2654273 (-104246922) + weightedMaskMass a 622612
        (115886947))) + (-weightedMaskMass a 2654228 (115886947) + (weightedMaskMass a 622616
        (31600475) + -weightedMaskMass a 2654276 (31600475)))) + ((weightedMaskMass a 622656
        (-264692710) + (-weightedMaskMass a 1057056 (-264692710) + weightedMaskMass a 622656
        (-73603874))) + (-weightedMaskMass a 2654216 (-73603874) + (weightedMaskMass a 622656
        (237964941) + -weightedMaskMass a 3670048 (237964941))))) + (((weightedMaskMass a 622657
        (70477171) + (-weightedMaskMass a 2654217 (70477171) + weightedMaskMass a 622660
        (-7030092))) + (-weightedMaskMass a 2654232 (-7030092) + (weightedMaskMass a 626752
        (308688945) + -weightedMaskMass a 1057568 (308688945)))) + ((weightedMaskMass a 626752
        (-237144167) + (-weightedMaskMass a 3670052 (-237144167) + weightedMaskMass a 630784
        (-9792365))) + ((-weightedMaskMass a 1313024 (-9792365) + weightedMaskMass a 630788
        (-51558953)) + (-weightedMaskMass a 1313040 (-51558953) + weightedMaskMass a 630792
        (-94576671)))))) + ((((-weightedMaskMass a 1313056 (-94576671) + (weightedMaskMass a 638977
        (-7049297) + -weightedMaskMass a 2670593 (-7049297))) + (weightedMaskMass a 638980
        (104033100) + (-weightedMaskMass a 2670608 (104033100) + weightedMaskMass a 638984
        (55758547)))) + ((-weightedMaskMass a 2670656 (55758547) + (weightedMaskMass a 638985
        (19666290) + -weightedMaskMass a 2670657 (19666290))) + (weightedMaskMass a 638992
        (-370784702) + (-weightedMaskMass a 2670596 (-370784702) + weightedMaskMass a 638996
        (274193813))))) + (((-weightedMaskMass a 2670612 (274193813) + (weightedMaskMass a 639000
        (359628666) + -weightedMaskMass a 2670660 (359628666))) + (weightedMaskMass a 639040
        (112761800) + (-weightedMaskMass a 2670600 (112761800) + weightedMaskMass a 639041
        (-95103870)))) + ((-weightedMaskMass a 2670601 (-95103870) + (weightedMaskMass a 639044
        (-178467979) + -weightedMaskMass a 2670616 (-178467979))) + ((weightedMaskMass a 655368
        (-5291424) + -weightedMaskMass a 2130048 (-5291424)) + (weightedMaskMass a 655392 (3693497)
        + -weightedMaskMass a 2097282 (3693497)))))))) + ((((((weightedMaskMass a 655424 (22110063)
        + (-weightedMaskMass a 671744 (22110063) + weightedMaskMass a 655424 (34953633))) +
        (-weightedMaskMass a 2097312 (34953633) + (weightedMaskMass a 655425 (34919024) +
        -weightedMaskMass a 2768896 (34919024)))) + ((weightedMaskMass a 655428 (-2505242) +
        (-weightedMaskMass a 675840 (-2505242) + weightedMaskMass a 655880 (-7147701))) +
        (-weightedMaskMass a 3178624 (-7147701) + (weightedMaskMass a 655904 (-3693497) +
        -weightedMaskMass a 2097346 (-3693497))))) + (((weightedMaskMass a 655936 (-69502820) +
        (-weightedMaskMass a 3145888 (-69502820) + weightedMaskMass a 659520 (-69317521))) +
        (-weightedMaskMass a 671748 (-69317521) + (weightedMaskMass a 659521 (39202060) +
        -weightedMaskMass a 2768900 (39202060)))) + ((weightedMaskMass a 659524 (41372229) +
        (-weightedMaskMass a 675844 (41372229) + weightedMaskMass a 671776 (-6200911))) +
        ((-weightedMaskMass a 2097314 (-6200911) + weightedMaskMass a 671809 (11144932)) +
        (-weightedMaskMass a 2768960 (11144932) + weightedMaskMass a 671812 (-12573271)))))) +
        ((((-weightedMaskMass a 675904 (-12573271) + (weightedMaskMass a 675841 (140817089) +
        -weightedMaskMass a 2752580 (140817089))) + (weightedMaskMass a 675905 (-105495515) +
        (-weightedMaskMass a 2768964 (-105495515) + weightedMaskMass a 688128 (-32593761)))) +
        ((-weightedMaskMass a 2359424 (-32593761) + (weightedMaskMass a 688129 (-18102048) +
        -weightedMaskMass a 2359428 (-18102048))) + (weightedMaskMass a 704512 (3473184) +
        (-weightedMaskMass a 2359456 (3473184) + weightedMaskMass a 704513 (99238153))))) +
        (((-weightedMaskMass a 2359460 (99238153) + (weightedMaskMass a 1049124 (23286560) +
        -weightedMaskMass a 1065089 (23286560))) + (weightedMaskMass a 1049124 (-142272024) +
        (-weightedMaskMass a 2097730 (-142272024) + weightedMaskMass a 1049128 (-115609592)))) +
        ((-weightedMaskMass a 1064996 (-115609592) + (weightedMaskMass a 1049128 (17443697) +
        -weightedMaskMass a 1065092 (17443697))) + ((weightedMaskMass a 1049152 (65663887) +
        -weightedMaskMass a 1179680 (65663887)) + (weightedMaskMass a 1049152 (-30388868) +
        -weightedMaskMass a 1179776 (-30388868))))))) + (((((weightedMaskMass a 1049154 (17856787) +
        (-weightedMaskMass a 1179684 (17856787) + weightedMaskMass a 1049154 (-45434738))) +
        (-weightedMaskMass a 1179778 (-45434738) + (weightedMaskMass a 1049378 (-28784338) +
        -weightedMaskMass a 3147812 (-28784338)))) + ((weightedMaskMass a 1049380 (88417229) +
        (-weightedMaskMass a 1097857 (88417229) + weightedMaskMass a 1049380 (-22624917))) +
        (-weightedMaskMass a 2228802 (-22624917) + (weightedMaskMass a 1049380 (121004465) +
        -weightedMaskMass a 3146276 (121004465))))) + (((weightedMaskMass a 1049384 (156494843) +
        (-weightedMaskMass a 3162148 (156494843) + weightedMaskMass a 1050644 (-52738706))) +
        (-weightedMaskMass a 1065218 (-52738706) + (weightedMaskMass a 1050644 (99979764) +
        -weightedMaskMass a 1607680 (99979764)))) + ((weightedMaskMass a 1050644 (-110178347) +
        (-weightedMaskMass a 2099240 (-110178347) + weightedMaskMass a 1050688 (62076623))) +
        ((-weightedMaskMass a 1179649 (62076623) + weightedMaskMass a 1050688 (-1409743)) +
        (-weightedMaskMass a 1179656 (-1409743) + weightedMaskMass a 1050753 (51864636)))))) +
        ((((-weightedMaskMass a 1050884 (51864636) + (weightedMaskMass a 1050753 (-41131052) +
        -weightedMaskMass a 1057028 (-41131052))) + (weightedMaskMass a 1050753 (-137720113) +
        (-weightedMaskMass a 1097730 (-137720113) + weightedMaskMass a 1050753 (33933759)))) +
        ((-weightedMaskMass a 2097698 (33933759) + (weightedMaskMass a 1050753 (65275122) +
        -weightedMaskMass a 2621984 (65275122))) + (weightedMaskMass a 1050816 (14053954) +
        (-weightedMaskMass a 1180168 (14053954) + weightedMaskMass a 1050900 (109837350))))) +
        (((-weightedMaskMass a 1097986 (109837350) + (weightedMaskMass a 1050916 (36192238) +
        -weightedMaskMass a 1097858 (36192238))) + (weightedMaskMass a 1050916 (-39403785) +
        (-weightedMaskMass a 3146274 (-39403785) + weightedMaskMass a 1050920 (51436102)))) +
        ((-weightedMaskMass a 3162146 (51436102) + (weightedMaskMass a 1052676 (-46894203) +
        -weightedMaskMass a 1343488 (-46894203))) + ((weightedMaskMass a 1052676 (-25595005) +
        -weightedMaskMass a 4194344 (-25595005)) + (weightedMaskMass a 1052676 (43061435) +
        -weightedMaskMass a 4194370 (43061435))))))))) := by
