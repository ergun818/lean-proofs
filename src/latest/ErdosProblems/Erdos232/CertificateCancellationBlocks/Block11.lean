...
theorem congruenceBlock11_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt11 s.val : ℝ)) = (((((((weightedMaskMass a 74816
        (20670514) + (-weightedMaskMass a 294932 (20670514) + weightedMaskMass a 74816 (142490568)))
        + (-weightedMaskMass a 525332 (142490568) + (weightedMaskMass a 74816 (-120897020) +
        -weightedMaskMass a 561156 (-120897020)))) + ((weightedMaskMass a 74816 (50740562) +
        (-weightedMaskMass a 2229312 (50740562) + weightedMaskMass a 74818 (-30037051))) +
        (-weightedMaskMass a 577540 (-30037051) + (weightedMaskMass a 74820 (-93011788) +
        -weightedMaskMass a 527380 (-93011788))))) + (((weightedMaskMass a 77832 (-39205362) +
        (-weightedMaskMass a 4853760 (-39205362) + weightedMaskMass a 78848 (-39265927))) +
        (-weightedMaskMass a 561408 (-39265927) + (weightedMaskMass a 78850 (53018166) +
        -weightedMaskMass a 577792 (53018166)))) + ((weightedMaskMass a 78912 (86226409) +
        (-weightedMaskMass a 561412 (86226409) + weightedMaskMass a 78914 (-32090602))) +
        ((-weightedMaskMass a 577796 (-32090602) + weightedMaskMass a 81929 (-29806013)) +
        (-weightedMaskMass a 2113601 (-29806013) + weightedMaskMass a 81938 (47759538)))))) +
        ((((-weightedMaskMass a 1049352 (47759538) + (weightedMaskMass a 81938 (62578461) +
        -weightedMaskMass a 2113572 (62578461))) + (weightedMaskMass a 81940 (111540339) +
        (-weightedMaskMass a 2113556 (111540339) + weightedMaskMass a 81954 (46583232)))) +
        ((-weightedMaskMass a 1050633 (46583232) + (weightedMaskMass a 81954 (19249356) +
        -weightedMaskMass a 1050888 (19249356))) + (weightedMaskMass a 81954 (9500466) +
        (-weightedMaskMass a 2113570 (9500466) + weightedMaskMass a 81956 (7862533))))) +
        (((-weightedMaskMass a 1049097 (7862533) + (weightedMaskMass a 81956 (82699415) +
        -weightedMaskMass a 2113554 (82699415))) + (weightedMaskMass a 81960 (10639400) +
        (-weightedMaskMass a 1064969 (10639400) + weightedMaskMass a 81960 (-173101102)))) +
        ((-weightedMaskMass a 2113602 (-173101102) + (weightedMaskMass a 81985 (41627687) +
        -weightedMaskMass a 82184 (41627687))) + ((weightedMaskMass a 81985 (-53547933) +
        -weightedMaskMass a 2113545 (-53547933)) + (weightedMaskMass a 81986 (14290941) +
        -weightedMaskMass a 1065224 (14290941))))))) + (((((weightedMaskMass a 81986 (-16904430) +
        (-weightedMaskMass a 2113576 (-16904430) + weightedMaskMass a 81988 (58726874))) +
        (-weightedMaskMass a 2113560 (58726874) + (weightedMaskMass a 82049 (-10685726) +
        -weightedMaskMass a 2097729 (-10685726)))) + ((weightedMaskMass a 82178 (-79322569) +
        (-weightedMaskMass a 2099209 (-79322569) + weightedMaskMass a 82180 (-127386742))) +
        (-weightedMaskMass a 2097673 (-127386742) + (weightedMaskMass a 82200 (13081051) +
        -weightedMaskMass a 86081 (13081051))))) + (((weightedMaskMass a 82208 (5406728) +
        (-weightedMaskMass a 3145737 (5406728) + weightedMaskMass a 82210 (-5743877))) +
        (-weightedMaskMass a 3147785 (-5743877) + (weightedMaskMass a 82212 (26012385) +
        -weightedMaskMass a 3146249 (26012385)))) + ((weightedMaskMass a 82216 (-26903075) +
        (-weightedMaskMass a 3162121 (-26903075) + weightedMaskMass a 82945 (-30432551))) +
        ((-weightedMaskMass a 2099265 (-30432551) + weightedMaskMass a 82945 (141916425)) +
        (-weightedMaskMass a 2375681 (141916425) + weightedMaskMass a 82946 (16853616)))))) +
        ((((-weightedMaskMass a 638976 (16853616) + (weightedMaskMass a 82946 (42382495) +
        -weightedMaskMass a 2375712 (42382495))) + (weightedMaskMass a 82946 (86621908) +
        (-weightedMaskMass a 2670592 (86621908) + weightedMaskMass a 82948 (-23929480)))) +
        ((-weightedMaskMass a 2375696 (-23929480) + (weightedMaskMass a 82962 (-187233140) +
        -weightedMaskMass a 2375716 (-187233140))) + (weightedMaskMass a 82964 (39545341) +
        (-weightedMaskMass a 2375700 (39545341) + weightedMaskMass a 83008 (134218080))))) +
        (((-weightedMaskMass a 2375688 (134218080) + (weightedMaskMass a 83009 (-194260056) +
        -weightedMaskMass a 2375689 (-194260056))) + (weightedMaskMass a 83010 (-220153785) +
        (-weightedMaskMass a 2375720 (-220153785) + weightedMaskMass a 83012 (-120318462)))) +
        ((-weightedMaskMass a 2375704 (-120318462) + (weightedMaskMass a 86018 (33166180) +
        -weightedMaskMass a 132161 (33166180))) + ((weightedMaskMass a 86018 (67163530) +
        -weightedMaskMass a 1048856 (67163530)) + (weightedMaskMass a 86050 (-63190556) +
        -weightedMaskMass a 1050904 (-63190556)))))))) + ((((((weightedMaskMass a 86082 (-93757850)
        + (-weightedMaskMass a 1065240 (-93757850) + weightedMaskMass a 87040 (20493836))) +
        (-weightedMaskMass a 270345 (20493836) + (weightedMaskMass a 90113 (-51738660) +
        -weightedMaskMass a 589833 (-51738660)))) + ((weightedMaskMass a 90113 (3833045) +
        (-weightedMaskMass a 2129985 (3833045) + weightedMaskMass a 90114 (-27742629))) +
        (-weightedMaskMass a 526345 (-27742629) + (weightedMaskMass a 90116 (45343700) +
        -weightedMaskMass a 524809 (45343700))))) + (((weightedMaskMass a 90121 (65186852) +
        (-weightedMaskMass a 606217 (65186852) + weightedMaskMass a 90121 (-20294563))) +
        (-weightedMaskMass a 2146369 (-20294563) + (weightedMaskMass a 90144 (30465936) +
        -weightedMaskMass a 1572873 (30465936)))) + ((weightedMaskMass a 2130052 (21032811) +
        (-weightedMaskMass a 2752520 (21032811) + weightedMaskMass a 90146 (-80767359))) +
        ((-weightedMaskMass a 1574921 (-80767359) + weightedMaskMass a 90148 (-98191688)) +
        (-weightedMaskMass a 1573385 (-98191688) + weightedMaskMass a 90152 (47009474)))))) +
        ((((-weightedMaskMass a 1589257 (47009474) + (weightedMaskMass a 90368 (19524667) +
        -weightedMaskMass a 98369 (19524667))) + (weightedMaskMass a 90368 (-30837427) +
        (-weightedMaskMass a 2621449 (-30837427) + weightedMaskMass a 90370 (40368496)))) +
        ((-weightedMaskMass a 2623497 (40368496) + (weightedMaskMass a 90372 (-42273772) +
        -weightedMaskMass a 2621961 (-42273772))) + (weightedMaskMass a 90376 (-119195659) +
        (-weightedMaskMass a 114753 (-119195659) + weightedMaskMass a 90376 (89867871))))) +
        (((-weightedMaskMass a 2637833 (89867871) + (weightedMaskMass a 90384 (-9138072) +
        -weightedMaskMass a 102465 (-9138072))) + (weightedMaskMass a 90392 (-11603435) +
        (-weightedMaskMass a 118849 (-11603435) + weightedMaskMass a 90400 (8249228)))) +
        ((-weightedMaskMass a 3670025 (8249228) + (weightedMaskMass a 90402 (49746393) +
        -weightedMaskMass a 3672073 (49746393))) + ((weightedMaskMass a 90404 (45150374) +
        -weightedMaskMass a 3670537 (45150374)) + (weightedMaskMass a 90408 (8287552) +
        -weightedMaskMass a 3686409 (8287552))))))) + (((((weightedMaskMass a 91137 (-96656858) +
        (-weightedMaskMass a 2132033 (-96656858) + weightedMaskMass a 98313 (148567995))) +
        (-weightedMaskMass a 2244609 (148567995) + (weightedMaskMass a 98313 (-28341570) +
        -weightedMaskMass a 2621505 (-28341570)))) + ((weightedMaskMass a 98322 (120891576) +
        (-weightedMaskMass a 626688 (120891576) + weightedMaskMass a 98322 (-169208484))) +
        (-weightedMaskMass a 1057536 (-169208484) + (weightedMaskMass a 98322 (50766853) +
        -weightedMaskMass a 2621476 (50766853))))) + (((weightedMaskMass a 98324 (-53329937) +
        (-weightedMaskMass a 2361352 (-53329937) + weightedMaskMass a 98324 (-5961934))) +
        (-weightedMaskMass a 2621460 (-5961934) + (weightedMaskMass a 98324 (7989011) +
        -weightedMaskMass a 5769216 (7989011)))) + ((weightedMaskMass a 98328 (76910016) +
        (-weightedMaskMass a 151553 (76910016) + weightedMaskMass a 98328 (-93160948))) +
        ((-weightedMaskMass a 2621508 (-93160948) + weightedMaskMass a 98370 (-84050088)) +
        (-weightedMaskMass a 1073408 (-84050088) + weightedMaskMass a 98370 (-52049619)))))) +
        ((((-weightedMaskMass a 2621480 (-52049619) + (weightedMaskMass a 98370 (-6243750) +
        -weightedMaskMass a 3702784 (-6243750))) + (weightedMaskMass a 98372 (22426224) +
        (-weightedMaskMass a 2621464 (22426224) + weightedMaskMass a 98372 (-73247734)))) +
        ((-weightedMaskMass a 3145752 (-73247734) + (weightedMaskMass a 98433 (74846141) +
        -weightedMaskMass a 2228737 (74846141))) + (weightedMaskMass a 98560 (-61648320) +
        (-weightedMaskMass a 196609 (-61648320) + weightedMaskMass a 98568 (125572547))))) +
        (((-weightedMaskMass a 212993 (125572547) + (weightedMaskMass a 98576 (59747011) +
        -weightedMaskMass a 200705 (59747011))) + (weightedMaskMass a 98584 (-67338251) +
        (-weightedMaskMass a 217089 (-67338251) + weightedMaskMass a 102402 (128447847)))) +
        ((-weightedMaskMass a 622608 (128447847) + (weightedMaskMass a 102402 (-94622199) +
        -weightedMaskMass a 1057040 (-94622199))) + ((weightedMaskMass a 102402 (-62475752) +
        -weightedMaskMass a 2654212 (-62475752)) + (weightedMaskMass a 102466 (103727629) +
        -weightedMaskMass a 1073424 (103727629))))))))) := by
