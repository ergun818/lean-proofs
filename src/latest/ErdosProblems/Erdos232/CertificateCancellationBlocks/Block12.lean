...
theorem congruenceBlock12_expectation_zero
  ...
  calc
    (∑ s, a s * (atomCongruenceContributionInt12 s.val : ℝ)) = (((((((weightedMaskMass a 102466
        (-30304120) + (-weightedMaskMass a 3702788 (-30304120) + weightedMaskMass a 106496
        (-91196820))) + (-weightedMaskMass a 163841 (-91196820) + (weightedMaskMass a 106496
        (5998653) + -weightedMaskMass a 262276 (5998653)))) + ((weightedMaskMass a 106496 (44744847)
        + (-weightedMaskMass a 1054720 (44744847) + weightedMaskMass a 106496 (-51186567))) +
        (-weightedMaskMass a 1312768 (-51186567) + (weightedMaskMass a 106496 (14338117) +
        -weightedMaskMass a 4196360 (14338117))))) + (((weightedMaskMass a 106497 (12366898) +
        (-weightedMaskMass a 2260993 (12366898) + weightedMaskMass a 106498 (-16970097))) +
        (-weightedMaskMass a 1312769 (-16970097) + (weightedMaskMass a 106500 (-4620865) +
        -weightedMaskMass a 1312784 (-4620865)))) + ((weightedMaskMass a 106500 (-38899852) +
        (-weightedMaskMass a 1579008 (-38899852) + weightedMaskMass a 106504 (115451989))) +
        ((-weightedMaskMass a 180225 (115451989) + weightedMaskMass a 106504 (-83010066)) +
        (-weightedMaskMass a 262308 (-83010066) + weightedMaskMass a 106504 (-673286)))))) +
        ((((-weightedMaskMass a 1312800 (-673286) + (weightedMaskMass a 106504 (21506129) +
        -weightedMaskMass a 4229128 (21506129))) + (weightedMaskMass a 106505 (57167935) +
        (-weightedMaskMass a 2277377 (57167935) + weightedMaskMass a 106512 (62685275)))) +
        ((-weightedMaskMass a 167937 (62685275) + (weightedMaskMass a 106512 (2609000) +
        -weightedMaskMass a 5249024 (2609000))) + (weightedMaskMass a 106516 (45538993) +
        (-weightedMaskMass a 5773312 (45538993) + weightedMaskMass a 106520 (1772082))))) +
        (((-weightedMaskMass a 184321 (1772082) + (weightedMaskMass a 106560 (143648145) +
        -weightedMaskMass a 295044 (143648145))) + (weightedMaskMass a 106752 (119830981) +
        (-weightedMaskMass a 229377 (119830981) + weightedMaskMass a 106760 (-19393284)))) +
        ((-weightedMaskMass a 245761 (-19393284) + (weightedMaskMass a 106768 (-99902041) +
        -weightedMaskMass a 233473 (-99902041))) + ((weightedMaskMass a 106776 (-15397280) +
        -weightedMaskMass a 249857 (-15397280)) + (weightedMaskMass a 114690 (-26779305) +
        -weightedMaskMass a 1057032 (-26779305))))))) + (((((weightedMaskMass a 114690 (-6238343) +
        (-weightedMaskMass a 2637856 (-6238343) + weightedMaskMass a 114692 (-8966115))) +
        (-weightedMaskMass a 2637840 (-8966115) + (weightedMaskMass a 114696 (14958184) +
        -weightedMaskMass a 147521 (14958184)))) + ((weightedMaskMass a 114696 (-183868611) +
        (-weightedMaskMass a 2637888 (-183868611) + weightedMaskMass a 114697 (-206830098))) +
        (-weightedMaskMass a 2244673 (-206830098) + (weightedMaskMass a 114697 (229524156) +
        -weightedMaskMass a 2637889 (229524156))))) + (((weightedMaskMass a 114706 (6604554) +
        (-weightedMaskMass a 1057544 (6604554) + weightedMaskMass a 114706 (-108581106))) +
        (-weightedMaskMass a 2637860 (-108581106) + (weightedMaskMass a 114708 (-189519175) +
        -weightedMaskMass a 2637844 (-189519175)))) + ((weightedMaskMass a 114712 (1117148) +
        (-weightedMaskMass a 151617 (1117148) + weightedMaskMass a 114712 (13379764))) +
        ((-weightedMaskMass a 2637892 (13379764) + weightedMaskMass a 114754 (68152340)) +
        (-weightedMaskMass a 1073416 (68152340) + weightedMaskMass a 114754 (14597934)))))) +
        ((((-weightedMaskMass a 2637864 (14597934) + (weightedMaskMass a 114756 (39336893) +
        -weightedMaskMass a 2637848 (39336893))) + (weightedMaskMass a 114816 (8221453) +
        (-weightedMaskMass a 131649 (8221453) + weightedMaskMass a 114817 (-154289239)))) +
        ((-weightedMaskMass a 2228801 (-154289239) + (weightedMaskMass a 114944 (70096339) +
        -weightedMaskMass a 196673 (70096339))) + (weightedMaskMass a 114952 (-119906939) +
        (-weightedMaskMass a 213057 (-119906939) + weightedMaskMass a 114960 (-41294764))))) +
        (((-weightedMaskMass a 200769 (-41294764) + (weightedMaskMass a 114968 (25816052) +
        -weightedMaskMass a 217153 (25816052))) + (weightedMaskMass a 118786 (-144757141) +
        (-weightedMaskMass a 1057048 (-144757141) + weightedMaskMass a 118850 (189626670)))) +
        ((-weightedMaskMass a 1073432 (189626670) + (weightedMaskMass a 122880 (49528838) +
        -weightedMaskMass a 163905 (49528838))) + ((weightedMaskMass a 122881 (-194769078) +
        -weightedMaskMass a 2261057 (-194769078)) + (weightedMaskMass a 122888 (69439039) +
        -weightedMaskMass a 180289 (69439039)))))))) + ((((((weightedMaskMass a 122889 (32922786) +
        (-weightedMaskMass a 2277441 (32922786) + weightedMaskMass a 122896 (-44032836))) +
        (-weightedMaskMass a 168001 (-44032836) + (weightedMaskMass a 122904 (-43905421) +
        -weightedMaskMass a 184385 (-43905421)))) + ((weightedMaskMass a 123136 (-108616093) +
        (-weightedMaskMass a 229441 (-108616093) + weightedMaskMass a 123144 (93987458))) +
        (-weightedMaskMass a 245825 (93987458) + (weightedMaskMass a 123152 (67505513) +
        -weightedMaskMass a 233537 (67505513))))) + (((weightedMaskMass a 123160 (-25376839) +
        (-weightedMaskMass a 249921 (-25376839) + weightedMaskMass a 131232 (-123581608))) +
        (-weightedMaskMass a 524864 (-123581608) + (weightedMaskMass a 131232 (43906732) +
        -weightedMaskMass a 1048736 (43906732)))) + ((weightedMaskMass a 131234 (-71067690) +
        (-weightedMaskMass a 1048740 (-71067690) + weightedMaskMass a 131234 (-65323770))) +
        ((-weightedMaskMass a 1050784 (-65323770) + weightedMaskMass a 131234 (69631929)) +
        (-weightedMaskMass a 2622016 (69631929) + weightedMaskMass a 131236 (-148705776)))))) +
        ((((-weightedMaskMass a 1048738 (-148705776) + (weightedMaskMass a 131265 (76541146) +
        -weightedMaskMass a 1048872 (76541146))) + (weightedMaskMass a 131265 (-72331096) +
        (-weightedMaskMass a 3162144 (-72331096) + weightedMaskMass a 131266 (20681894)))) +
        ((-weightedMaskMass a 131650 (20681894) + (weightedMaskMass a 131266 (-22712865) +
        -weightedMaskMass a 1048868 (-22712865))) + (weightedMaskMass a 131266 (-81421472) +
        (-weightedMaskMass a 1097856 (-81421472) + weightedMaskMass a 131266 (-12993442))))) +
        (((-weightedMaskMass a 3146272 (-12993442) + (weightedMaskMass a 131268 (21719365) +
        -weightedMaskMass a 559112 (21719365))) + (weightedMaskMass a 131268 (-112362324) +
        (-weightedMaskMass a 1048866 (-112362324) + weightedMaskMass a 131268 (-4611919)))) +
        ((-weightedMaskMass a 3147808 (-4611919) + (weightedMaskMass a 131328 (64069867) +
        -weightedMaskMass a 1048640 (64069867))) + ((weightedMaskMass a 131328 (-53556320) +
        -weightedMaskMass a 1179648 (-53556320)) + (weightedMaskMass a 131330 (104721081) +
        -weightedMaskMass a 1048644 (104721081))))))) + (((((weightedMaskMass a 131332 (21904954) +
        (-weightedMaskMass a 1048642 (21904954) + weightedMaskMass a 131332 (129379926))) +
        (-weightedMaskMass a 1179650 (129379926) + (weightedMaskMass a 131332 (-46529769) +
        -weightedMaskMass a 1179652 (-46529769)))) + ((weightedMaskMass a 131336 (-8493195) +
        (-weightedMaskMass a 1048641 (-8493195) + weightedMaskMass a 131360 (-5726220))) +
        (-weightedMaskMass a 1048768 (-5726220) + (weightedMaskMass a 131360 (60731407) +
        -weightedMaskMass a 1180160 (60731407))))) + (((weightedMaskMass a 131360 (-48156438) +
        (-weightedMaskMass a 3145792 (-48156438) + weightedMaskMass a 131362 (-117160205))) +
        (-weightedMaskMass a 1048772 (-117160205) + (weightedMaskMass a 131364 (-62195515) +
        -weightedMaskMass a 1048770 (-62195515)))) + ((weightedMaskMass a 131364 (-69719946) +
        (-weightedMaskMass a 1180162 (-69719946) + weightedMaskMass a 131368 (977242))) +
        ((-weightedMaskMass a 1048769 (977242) + weightedMaskMass a 131392 (-10741762)) +
        (-weightedMaskMass a 1048896 (-10741762) + weightedMaskMass a 131394 (-89670437)))))) +
        ((((-weightedMaskMass a 1048900 (-89670437) + (weightedMaskMass a 131396 (-49482906) +
        -weightedMaskMass a 1048898 (-49482906))) + (weightedMaskMass a 131618 (-58640434) +
        (-weightedMaskMass a 1083520 (-58640434) + weightedMaskMass a 131624 (163171357)))) +
        ((-weightedMaskMass a 524840 (163171357) + (weightedMaskMass a 131624 (-49769785) +
        -weightedMaskMass a 1073156 (-49769785))) + (weightedMaskMass a 131652 (31483988) +
        (-weightedMaskMass a 559168 (31483988) + weightedMaskMass a 131840 (228215))))) +
        (((-weightedMaskMass a 3276800 (228215) + (weightedMaskMass a 131844 (-18631674) +
        -weightedMaskMass a 3276802 (-18631674))) + (weightedMaskMass a 131872 (-5151387) +
        (-weightedMaskMass a 3277312 (-5151387) + weightedMaskMass a 131876 (67383751)))) +
        ((-weightedMaskMass a 3277314 (67383751) + (weightedMaskMass a 132672 (-36907083) +
        -weightedMaskMass a 196800 (-36907083))) + ((weightedMaskMass a 132672 (148171446) +
        -weightedMaskMass a 557080 (148171446)) + (weightedMaskMass a 132672 (85155618) +
        -weightedMaskMass a 557124 (85155618))))))))) := by
