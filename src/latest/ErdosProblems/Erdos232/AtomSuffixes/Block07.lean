...
theorem certificateAtomInt_suffix_0589824 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons true).cons false).cons false).cons true).cons false).cons false).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          true).cons false).cons false).cons true).cons false).cons false).cons false).toNat := by
...
theorem certificateAtomInt_suffix_0622592 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons true).cons false).cons false).cons true).cons false).cons false).cons false) =
        true →
...
theorem certificateAtomInt_suffix_0651264 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons true).cons true).cons true).cons true).cons
        true).cons false).cons false).cons true).cons false).cons false).cons false) = true →
