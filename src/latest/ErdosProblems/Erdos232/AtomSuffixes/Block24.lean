...
theorem certificateAtomInt_suffix_5505024 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons false).cons false).cons true).cons false).cons true).cons false).cons true) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          false).cons false).cons true).cons false).cons true).cons false).cons true).toNat := by
...
theorem certificateAtomInt_suffix_5537792 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons false).cons true).cons false).cons true).cons false).cons true) =
        true →
...
theorem certificateAtomInt_suffix_5566464 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons true).cons true).cons true).cons true).cons
        false).cons false).cons true).cons false).cons true).cons false).cons true) = true →
