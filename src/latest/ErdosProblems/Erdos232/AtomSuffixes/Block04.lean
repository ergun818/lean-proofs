...
theorem certificateAtomInt_suffix_0327680 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons true).cons false).cons true).cons false).cons false).cons false).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          true).cons false).cons true).cons false).cons false).cons false).cons false).toNat := by
...
theorem certificateAtomInt_suffix_0360448 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons true).cons false).cons true).cons false).cons false).cons false).cons false) =
        true →
...
theorem certificateAtomInt_suffix_0389120 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons true).cons true).cons true).cons true).cons
        true).cons false).cons true).cons false).cons false).cons false).cons false) = true →
