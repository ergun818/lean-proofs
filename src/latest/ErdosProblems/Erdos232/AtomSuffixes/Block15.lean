...
theorem certificateAtomInt_suffix_2621440 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons false).cons false).cons false).cons true).cons false).cons true).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          false).cons false).cons false).cons true).cons false).cons true).cons false).toNat := by
  rw [BitVec.forall_cons_iff]
  intro b11
  cases b11
  · rw [BitVec.forall_cons_iff]
...
theorem certificateAtomInt_suffix_2654208 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons false).cons false).cons true).cons false).cons true).cons false) =
        true →
...
theorem certificateAtomInt_suffix_2752512 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons false).cons true).cons false).cons true).cons false).cons true).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          false).cons true).cons false).cons true).cons false).cons true).cons false).toNat := by
  rw [BitVec.forall_cons_iff]
  intro b11
  cases b11
  · rw [BitVec.forall_cons_iff]
...
theorem certificateAtomInt_suffix_2785280 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons true).cons false).cons true).cons false).cons true).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons true).cons
          false).cons true).cons false).cons true).cons false).cons true).cons false).toNat := by
  rw [BitVec.forall_cons_iff]
...
theorem certificateAtomInt_suffix_3145728 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons false).cons false).cons false).cons false).cons true).cons true).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          false).cons false).cons false).cons false).cons true).cons true).cons false).toNat := by
  rw [BitVec.forall_cons_iff]
  intro b11
  cases b11
  · rw [BitVec.forall_cons_iff]
