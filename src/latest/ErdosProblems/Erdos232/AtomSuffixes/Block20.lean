...
theorem certificateAtomInt_suffix_4489216 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons false).cons true).cons false).cons false).cons false).cons true) =
        true →
...
theorem certificateAtomInt_suffix_4517888 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons true).cons true).cons true).cons true).cons
        false).cons false).cons true).cons false).cons false).cons false).cons true) = true →
...
theorem certificateAtomInt_suffix_4587520 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons false).cons true).cons true).cons false).cons false).cons false).cons true) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          false).cons true).cons true).cons false).cons false).cons false).cons true).toNat := by
  rw [BitVec.forall_cons_iff]
  intro b11
  cases b11
  · rw [BitVec.forall_cons_iff]
...
theorem certificateAtomInt_suffix_4620288 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons true).cons true).cons false).cons false).cons false).cons true) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons true).cons
          false).cons true).cons true).cons false).cons false).cons false).cons true).toNat := by
  rw [BitVec.forall_cons_iff]
