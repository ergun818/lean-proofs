...
theorem certificateAtomInt_suffix_1343488 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons false).cons true).cons false).cons true).cons false).cons false) =
        true →
...
theorem certificateAtomInt_suffix_1372160 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons true).cons true).cons true).cons true).cons
        false).cons false).cons true).cons false).cons true).cons false).cons false) = true →
...
theorem certificateAtomInt_suffix_1441792 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        false).cons false).cons true).cons true).cons false).cons true).cons false).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons false).cons
          false).cons true).cons true).cons false).cons true).cons false).cons false).toNat := by
  rw [BitVec.forall_cons_iff]
  intro b11
  cases b11
  · rw [BitVec.forall_cons_iff]
...
theorem certificateAtomInt_suffix_1474560 :
    ∀ s : BitVec 12, independentMaskBV (((((((((((s.cons false).cons false).cons false).cons
        true).cons false).cons true).cons true).cons false).cons true).cons false).cons false) =
        true →
      0 ≤ certificateAtomInt (((((((((((s.cons false).cons false).cons false).cons true).cons
          false).cons true).cons true).cons false).cons true).cons false).cons false).toNat := by
  rw [BitVec.forall_cons_iff]
