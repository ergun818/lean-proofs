...
private theorem maskCongruent_suffix_23_022 :
    ∀ c : (Nat × Nat × Int), c ∈ [(5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] →
...
private theorem maskCongruent_suffix_23_021 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4767768, 4767812, 138658897), (5505064, 5537800, -102603613),
        (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_020 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4767753, 4767809, 7062562), (4767768, 4767812, 138658897),
        (5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 :=
        by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_019 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4767752, 4767808, -43222421), (4767753, 4767809, 7062562),
        (4767768, 4767812, 138658897), (5505064, 5537800, -102603613), (5507112, 5539848,
        169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_018 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4767748, 4767760, 68926203), (4767752, 4767808, -43222421),
        (4767753, 4767809, 7062562), (4767768, 4767812, 138658897), (5505064, 5537800, -102603613),
        (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_017 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4751384, 4751428, -35363714), (4767748, 4767760, 68926203),
        (4767752, 4767808, -43222421), (4767753, 4767809, 7062562), (4767768, 4767812, 138658897),
        (5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 :=
        by
  intro c hc
  rw [List.mem_cons] at hc
...
private theorem maskCongruent_suffix_23_016 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4751369, 4751425, -94952655), (4751384, 4751428, -35363714),
        (4767748, 4767760, 68926203), (4767752, 4767808, -43222421), (4767753, 4767809, 7062562),
        (4767768, 4767812, 138658897), (5505064, 5537800, -102603613), (5507112, 5539848,
        169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
...
private theorem maskCongruent_suffix_23_015 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4723776, 5505060, 55712557), (4751369, 4751425, -94952655),
        (4751384, 4751428, -35363714), (4767748, 4767760, 68926203), (4767752, 4767808, -43222421),
        (4767753, 4767809, 7062562), (4767768, 4767812, 138658897), (5505064, 5537800, -102603613),
        (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
...
private theorem maskCongruent_suffix_23_014 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505624, 4736068, 374809555), (4723776, 5505060, 55712557),
        (4751369, 4751425, -94952655), (4751384, 4751428, -35363714), (4767748, 4767760, 68926203),
        (4767752, 4767808, -43222421), (4767753, 4767809, 7062562), (4767768, 4767812, 138658897),
        (5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 :=
        by
  intro c hc
...
private theorem maskCongruent_suffix_23_013 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505620, 4736020, 638064904), (4505624, 4736068, 374809555),
        (4723776, 5505060, 55712557), (4751369, 4751425, -94952655), (4751384, 4751428, -35363714),
        (4767748, 4767760, 68926203), (4767752, 4767808, -43222421), (4767753, 4767809, 7062562),
        (4767768, 4767812, 138658897), (5505064, 5537800, -102603613), (5507112, 5539848,
        169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
...
private theorem maskCongruent_suffix_23_012 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505616, 4736004, -387746007), (4505620, 4736020, 638064904),
        (4505624, 4736068, 374809555), (4723776, 5505060, 55712557), (4751369, 4751425, -94952655),
        (4751384, 4751428, -35363714), (4767748, 4767760, 68926203), (4767752, 4767808, -43222421),
        (4767753, 4767809, 7062562), (4767768, 4767812, 138658897), (5505064, 5537800, -102603613),
        (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
...
private theorem maskCongruent_suffix_23_011 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505609, 4736065, -56537170), (4505616, 4736004, -387746007),
        (4505620, 4736020, 638064904), (4505624, 4736068, 374809555), (4723776, 5505060, 55712557),
        (4751369, 4751425, -94952655), (4751384, 4751428, -35363714), (4767748, 4767760, 68926203),
        (4767752, 4767808, -43222421), (4767753, 4767809, 7062562), (4767768, 4767812, 138658897),
        (5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 :=
        by
...
private theorem maskCongruent_suffix_23_010 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505608, 4736064, -15827094), (4505609, 4736065, -56537170),
        (4505616, 4736004, -387746007), (4505620, 4736020, 638064904), (4505624, 4736068,
        374809555), (4723776, 5505060, 55712557), (4751369, 4751425, -94952655), (4751384, 4751428,
        -35363714), (4767748, 4767760, 68926203), (4767752, 4767808, -43222421), (4767753, 4767809,
        7062562), (4767768, 4767812, 138658897), (5505064, 5537800, -102603613), (5507112, 5539848,
        169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_009 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505604, 4736016, -119876439), (4505608, 4736064, -15827094),
        (4505609, 4736065, -56537170), (4505616, 4736004, -387746007), (4505620, 4736020,
        638064904), (4505624, 4736068, 374809555), (4723776, 5505060, 55712557), (4751369, 4751425,
        -94952655), (4751384, 4751428, -35363714), (4767748, 4767760, 68926203), (4767752, 4767808,
        -43222421), (4767753, 4767809, 7062562), (4767768, 4767812, 138658897), (5505064, 5537800,
        -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_008 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505601, 4736001, -83590859), (4505604, 4736016, -119876439),
        (4505608, 4736064, -15827094), (4505609, 4736065, -56537170), (4505616, 4736004,
        -387746007), (4505620, 4736020, 638064904), (4505624, 4736068, 374809555), (4723776,
        5505060, 55712557), (4751369, 4751425, -94952655), (4751384, 4751428, -35363714), (4767748,
        4767760, 68926203), (4767752, 4767808, -43222421), (4767753, 4767809, 7062562), (4767768,
        4767812, 138658897), (5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] →
        MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_007 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4505600, 4736000, 86389790), (4505601, 4736001, -83590859),
        (4505604, 4736016, -119876439), (4505608, 4736064, -15827094), (4505609, 4736065,
        -56537170), (4505616, 4736004, -387746007), (4505620, 4736020, 638064904), (4505624,
        4736068, 374809555), (4723776, 5505060, 55712557), (4751369, 4751425, -94952655), (4751384,
        4751428, -35363714), (4767748, 4767760, 68926203), (4767752, 4767808, -43222421), (4767753,
        4767809, 7062562), (4767768, 4767812, 138658897), (5505064, 5537800, -102603613), (5507112,
        5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_006 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4491272, 5507104, 113394222), (4505600, 4736000, 86389790),
        (4505601, 4736001, -83590859), (4505604, 4736016, -119876439), (4505608, 4736064,
        -15827094), (4505609, 4736065, -56537170), (4505616, 4736004, -387746007), (4505620,
        4736020, 638064904), (4505624, 4736068, 374809555), (4723776, 5505060, 55712557), (4751369,
        4751425, -94952655), (4751384, 4751428, -35363714), (4767748, 4767760, 68926203), (4767752,
        4767808, -43222421), (4767753, 4767809, 7062562), (4767768, 4767812, 138658897), (5505064,
        5537800, -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
  intro c hc
  rw [List.mem_cons] at hc
  rcases hc with hc | hc
...
private theorem maskCongruent_suffix_23_005 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4489240, 4719684, -162785421), (4491272, 5507104, 113394222),
        (4505600, 4736000, 86389790), (4505601, 4736001, -83590859), (4505604, 4736016, -119876439),
        (4505608, 4736064, -15827094), (4505609, 4736065, -56537170), (4505616, 4736004,
        -387746007), (4505620, 4736020, 638064904), (4505624, 4736068, 374809555), (4723776,
        5505060, 55712557), (4751369, 4751425, -94952655), (4751384, 4751428, -35363714), (4767748,
        4767760, 68926203), (4767752, 4767808, -43222421), (4767753, 4767809, 7062562), (4767768,
...
private theorem maskCongruent_suffix_23_004 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4489236, 4719636, -239857632), (4489240, 4719684, -162785421),
        (4491272, 5507104, 113394222), (4505600, 4736000, 86389790), (4505601, 4736001, -83590859),
        (4505604, 4736016, -119876439), (4505608, 4736064, -15827094), (4505609, 4736065,
        -56537170), (4505616, 4736004, -387746007), (4505620, 4736020, 638064904), (4505624,
        4736068, 374809555), (4723776, 5505060, 55712557), (4751369, 4751425, -94952655), (4751384,
        4751428, -35363714), (4767748, 4767760, 68926203), (4767752, 4767808, -43222421), (4767753,
...
private theorem maskCongruent_suffix_23_003 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4489225, 4719681, -120736053), (4489236, 4719636, -239857632),
        (4489240, 4719684, -162785421), (4491272, 5507104, 113394222), (4505600, 4736000, 86389790),
        (4505601, 4736001, -83590859), (4505604, 4736016, -119876439), (4505608, 4736064,
        -15827094), (4505609, 4736065, -56537170), (4505616, 4736004, -387746007), (4505620,
        4736020, 638064904), (4505624, 4736068, 374809555), (4723776, 5505060, 55712557), (4751369,
        4751425, -94952655), (4751384, 4751428, -35363714), (4767748, 4767760, 68926203), (4767752,
...
private theorem maskCongruent_suffix_23_002 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4489224, 5505056, -69839133), (4489225, 4719681, -120736053),
        (4489236, 4719636, -239857632), (4489240, 4719684, -162785421), (4491272, 5507104,
        113394222), (4505600, 4736000, 86389790), (4505601, 4736001, -83590859), (4505604, 4736016,
        -119876439), (4505608, 4736064, -15827094), (4505609, 4736065, -56537170), (4505616,
        4736004, -387746007), (4505620, 4736020, 638064904), (4505624, 4736068, 374809555),
        (4723776, 5505060, 55712557), (4751369, 4751425, -94952655), (4751384, 4751428, -35363714),
        (4767748, 4767760, 68926203), (4767752, 4767808, -43222421), (4767753, 4767809, 7062562),
        (4767768, 4767812, 138658897), (5505064, 5537800, -102603613), (5507112, 5539848,
        169269087)] → MaskCongruent c.1 c.2.1 := by
...
private theorem maskCongruent_suffix_23_001 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4489224, 4719680, 160471052), (4489224, 5505056, -69839133),
        (4489225, 4719681, -120736053), (4489236, 4719636, -239857632), (4489240, 4719684,
        -162785421), (4491272, 5507104, 113394222), (4505600, 4736000, 86389790), (4505601, 4736001,
        -83590859), (4505604, 4736016, -119876439), (4505608, 4736064, -15827094), (4505609,
        4736065, -56537170), (4505616, 4736004, -387746007), (4505620, 4736020, 638064904),
        (4505624, 4736068, 374809555), (4723776, 5505060, 55712557), (4751369, 4751425, -94952655),
        (4751384, 4751428, -35363714), (4767748, 4767760, 68926203), (4767752, 4767808, -43222421),
        (4767753, 4767809, 7062562), (4767768, 4767812, 138658897), (5505064, 5537800, -102603613),
        (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 := by
...
private theorem maskCongruent_suffix_23_000 :
    ∀ c : (Nat × Nat × Int), c ∈ [(4489217, 4719617, 136002196), (4489224, 4719680, 160471052),
        (4489224, 5505056, -69839133), (4489225, 4719681, -120736053), (4489236, 4719636,
        -239857632), (4489240, 4719684, -162785421), (4491272, 5507104, 113394222), (4505600,
        4736000, 86389790), (4505601, 4736001, -83590859), (4505604, 4736016, -119876439), (4505608,
        4736064, -15827094), (4505609, 4736065, -56537170), (4505616, 4736004, -387746007),
        (4505620, 4736020, 638064904), (4505624, 4736068, 374809555), (4723776, 5505060, 55712557),
        (4751369, 4751425, -94952655), (4751384, 4751428, -35363714), (4767748, 4767760, 68926203),
        (4767752, 4767808, -43222421), (4767753, 4767809, 7062562), (4767768, 4767812, 138658897),
        (5505064, 5537800, -102603613), (5507112, 5539848, 169269087)] → MaskCongruent c.1 c.2.1 :=
