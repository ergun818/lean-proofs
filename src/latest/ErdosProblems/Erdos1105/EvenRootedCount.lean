...
theorem even_path_bound_of_rooted_path_bound {V : Type*} [Fintype V]
    ...
    G.edgeFinset.card ≤ pathFormula (Fintype.card V) (2 * l + 2) := by
  classical
  exact rooted_count_le_even_formula _ _ _ hl hn
